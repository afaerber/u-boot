/*
 *  u-boot/include/configs/msb7701.h
 *
...
#define CONFIG_BOOTCOMMAND_EMMC "mmc dev 0; mmc rescan; ext2load mmc 0:1 80008000 boot/Image; ext2load mmc 0:1 81000000 boot/msb7701.dtb; bootm 80008000 - 81000000"
#define CONFIG_BOOTCOMMAND_SD   "mmc dev 1; mmc rescan; ext2load mmc 1:1 80008000 boot/Image; ext2load mmc 1:1 81000000 boot/msb7701.dtb; bootm 80008000 - 81000000"
#define CONFIG_BOOTCOMMAND      CONFIG_BOOTCOMMAND_EMMC

#define CONFIG_BOOTARGS_EMMC    "shm_offset=2048 loglevel=4 console=ttyAMA0,115200 root=/dev/mmcblk0p1 rootfstype=ext4 rootwait rw"
#define CONFIG_BOOTARGS_SD      "shm_offset=2048 loglevel=4 console=ttyAMA0,115200 root=/dev/mmcblk1p1 rootfstype=ext4 rootwait rw"
#define CONFIG_BOOTARGS         CONFIG_BOOTARGS_EMMC
