...
static int power_init_s5m8767(void)
{
	...
	error |= s5m8767_volsetting(S5M8767_LDO3, CONFIG_VDD_LDO3_MV,
					S5M8767_REG_ENABLE, S5M8767_MV);
	error |= s5m8767_volsetting(S5M8767_LDO5, CONFIG_VDD_LDO5_MV,
					S5M8767_REG_DISABLE, S5M8767_MV);
	error |= s5m8767_volsetting(S5M8767_LDO10, CONFIG_VDD_LDO10_MV,
					S5M8767_REG_ENABLE, S5M8767_MV);
	error |= s5m8767_volsetting(S5M8767_LDO11, CONFIG_VDD_LDO11_MV,
					S5M8767_REG_DISABLE, S5M8767_MV);
	error |= s5m8767_volsetting(S5M8767_LDO13, CONFIG_VDD_LDO13_MV,
					S5M8767_REG_DISABLE, S5M8767_MV);
	error |= s5m8767_volsetting(S5M8767_LDO17, CONFIG_VDD_LDO17_MV,
					S5M8767_REG_DISABLE, S5M8767_MV);
	return error;
}
